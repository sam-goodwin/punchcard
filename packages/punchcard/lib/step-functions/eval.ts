 ...
 */
export function $state<V extends Vars>(vars: V): Generator<unknown, {
  [ID in Extract<keyof V, string>]: State<Thing.Of<V[ID]>, ID>;
}>;

export function $state<ID extends string, T extends ShapeOrRecord>(id: ID, type: T): Generator<unknown, State<Thing.Of<T>, ID>>;
export function $state<ID extends string, T extends ShapeOrRecord>(id: ID, type: T, value: Value.Of<T>): Generator<unknown, State<Thing.Of<T>, ID>>;
