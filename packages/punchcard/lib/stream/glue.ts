 ...
 */
export class GlueTableCollector<S extends Shape, P extends Glue.Partition, E extends Enumerable<any, RuntimeShape<S>, any, any>> implements Collector<CollectedGlueTable<S, P, E>, E> {
 ...
 */
export interface CollectedGlueTableProps<S extends Shape, P extends Glue.Partition, E extends Enumerable<any, RuntimeShape<S>, any, any>> extends Glue.TableProps<S, P> {
  /**
 ...
 * @typeparam T type of notififcations sent to, and emitted from, the Glue Table.
 */
export class CollectedGlueTable<S extends Shape, P extends Glue.Partition, E extends Enumerable<any, any, any, any>> extends Glue.Table<S, P> {
