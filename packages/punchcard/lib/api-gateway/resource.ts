...
export class Resource extends Tree<Resource> {
  ...
  public setDeleteMethod<R extends Context, T extends Shape, U extends Responses>(method: Method<R, T, U, 'DELETE'>) {
    this.addMethod('DELETE', method);
  }

  public setGetMethod<R extends Context, T extends Shape, U extends Responses>(method: Method<R, T, U, 'GET'>) {
    this.addMethod('GET', method);
  }

  public setHeadMethod<R extends Context, T extends Shape, U extends Responses>(method: Method<R, T, U, 'HEAD'>) {
    this.addMethod('HEAD', method);
  }

  public setOptionsMethod<R extends Context, T extends Shape, U extends Responses>(method: Method<R, T, U, 'OPTIONS'>) {
    this.addMethod('OPTIONS', method);
  }

  public setPatchMethod<R extends Context, T extends Shape, U extends Responses>(method: Method<R, T, U, 'PATCH'>) {
    this.addMethod('PATCH', method);
  }

  public setPostMethod<R extends Context, T extends Shape, U extends Responses>(method: Method<R, T, U, 'POST'>) {
    this.addMethod('POST', method);
  }

  public setPutMethod<R extends Context, T extends Shape, U extends Responses>(method: Method<R, T, U, 'PUT'>) {
