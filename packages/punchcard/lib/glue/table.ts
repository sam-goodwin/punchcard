...
export namespace Table {
   ...
   * Client type aliaes.
   */
  export interface ReadWriteClient<C extends Columns, P extends PartitionKeys> extends Table.Client<C, P> {}
  export interface ReadClient<C extends Columns, P extends PartitionKeys> extends Omit<Table.Client<C, P>, 'batchCreatePartition' | 'createPartition' | 'updatePartition' | 'sink'> {}
  export interface WriteClient<C extends Columns, P extends PartitionKeys> extends Omit<Table.Client<C, P>, 'getPartitions'> {}

  /**
   * Request and Response aliases.
   *
   * Note: we use interfaces to assign names to constructed types.
   */
  export interface GetPartitionsRequest extends Omit<AWS.Glue.GetPartitionsRequest, 'CatalogId' | 'DatabaseName' | 'TableName'> {}
  type _GetPartitionsResponse<P extends PartitionKeys> = {
    Partitions: Array<{
  ...
  type _CreatePartitionRequest<P extends PartitionKeys> = {
    Partition: RuntimeShape<StructShape<P>>;
    Location: string, LastAccessTime?: Date
  ...
  export type _UpdatePartitionRequest<P extends PartitionKeys> = {Partition: RuntimeShape<StructShape<P>>, UpdatedPartition: CreatePartitionRequest<P>};
  export interface UpdatePartitionRequest<P extends PartitionKeys> extends _UpdatePartitionRequest<P> {}
