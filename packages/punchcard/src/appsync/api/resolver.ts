...
import { VAny, VObject } from '../lang/vtl-object';
  ...
  & ReturnsValue extends true ? ThisType<SelfType<Self>> & {
    readonly resolve: T extends FunctionShape<infer Args, infer Returns> ?
      ...
      (
        ...
        self: SelfType<Self>
      ) => VTL<VAny | VObject.Of<DistributeUnionShape<Returns>>> :
      // no args if it is not a Function type
      (self: VObject.Of<Self>) => VTL<VAny | VObject.Of<DistributeUnionShape<T>>>
    ;
