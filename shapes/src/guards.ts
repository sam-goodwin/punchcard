...
export namespace ShapeGuards {
  export const isDynamicShape = (a: any): a is DynamicShape<unknown> =>
    isShape(a) && a.Kind === "dynamicShape";
  export const assertDynamicShape = (
    a: any,
  ): asserts a is DynamicShape<unknown> => {
    if (!isDynamicShape(a)) {
      throw new Error(`${a} is not of type: DynamicShape`);
    }
  };

  export const isAnyShape = (a: any): a is AnyShape =>
    isDynamicShape(a) && a.Tag === "any";
  ...
  export const isUnknownShape = (a: any): a is UnknownShape =>
    isDynamicShape(a) && a.Tag === "unknown";
  ...
  export const isBinaryShape = (a: any): a is BinaryShape =>
    isShape(a) && a.Kind === "binaryShape";
  ...
  export const isArrayShape = (a: any): a is ArrayShape<any> =>
    a.Kind === "arrayShape";
  ...
  export const isBoolShape = (a: any): a is BoolShape =>
    isShape(a) && a.Kind === "boolShape";
  export const assertBoolShape = (a: any): asserts a is BoolShape => {
    if (!isBoolShape(a)) {
      throw new Error(`${a} is not of type: BoolShape`);
    }
  };
  export const isRecordShape = (a: any): a is RecordShape<any> =>
    isShape(a) && a.Kind === "recordShape";
  ...
  export const isMapShape = (a: any): a is MapShape<any> =>
    a.Kind === "mapShape";
  ...
  // numeric
  export const isNumericShape = (a: any): a is NumericShape =>
    isShape(a) && (isNumberShape(a) || isIntegerShape(a));
  export const assertNumericShape = (a: any): asserts a is NumericShape => {
    if (!isNumericShape(a)) {
      throw new Error(`${a} is not of type: NumericShape`);
    }
  };
  export const isIntegerShape = (a: any): a is IntegerShape =>
    isShape(a) && a.Kind === "integerShape";
  export const assertIntegerShape = (a: any): asserts a is IntegerShape => {
    if (!isIntegerShape(a)) {
      throw new Error(`${a} is not of type: IntegerShape`);
    }
  };
  export const isNumberShape = (a: any): a is NumberShape =>
    isShape(a) && a.Kind === "numberShape";
  ...
  export const isSetShape = (a: any): a is SetShape<any> =>
    a.Kind === "setShape";
  ...
  export const isStringShape = (a: any): a is StringShape =>
    isShape(a) && a.Kind === "stringShape";
  export const assertStringShape = (a: any): asserts a is StringShape => {
    if (!isStringShape(a)) {
      throw new Error(`${a} is not of type: StringShape`);
    }
  };
  export const isTimestampShape = (a: any): a is TimestampShape =>
    isShape(a) && a.Kind === "timestampShape";
