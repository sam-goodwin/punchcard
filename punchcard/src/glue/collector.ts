...
declare module "../util/stream" {
  interface Stream<E, T, D extends any[], C> {
     ...
     */
    toGlueTable<T extends RecordType, P extends RecordType>(
      scope: Build<cdk.Construct>,
      id: string,
      tableProps: TableProps<T, P>,
      runtimeConfig?: T,
    ): CollectedGlueTable<T, P, this>;
  }
}
Stream.prototype.toGlueTable = function(
  scope: Build<cdk.Construct>,
  id: string,
  tableProps: any,
): any {
 ...
 */
export class GlueTableCollector<
  T extends RecordType,
  P extends RecordType,
  S extends Stream<any, Value.Of<T>, any, any>
> implements Collector<CollectedGlueTable<T, P, S>, S> {
 ...
 */
export interface CollectedGlueTableProps<
  T extends RecordType,
  P extends RecordType,
  S extends Stream<any, Value.Of<T>, any, any>
> extends TableProps<T, P> {
  /**
 ...
 */
export class CollectedGlueTable<
  T extends RecordType,
  P extends RecordType,
...
> extends Table<T, P> {
  public readonly sender: Function<
    EventType<S>,
    NothingShape,
    Dependency.Concat<Cons<DependencyType<S>, Dependency<Table.Client<T, P>>>>
  >;

  constructor(
    scope: Build<cdk.Construct>,
    id: string,
    props: CollectedGlueTableProps<T, P, S>,
  ) {
