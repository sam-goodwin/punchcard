...
export namespace Collectors {
   ...
   */
  export function toSQSQueue<T extends Shape>(
    props: SQS.QueueProps<T>,
  ): SQS.QueueCollector<T, any> {
   ...
   */
  export function toKinesisStream<T extends Shape>(
    props: Kinesis.StreamProps<T>,
  ): Kinesis.StreamCollector<T, any> {
   ...
   * @param props - stream properties
   */
  export function toFirehoseDeliveryStream<T extends Shape>(
    props: Firehose.DeliveryStreamDirectPut<T>,
  ): Firehose.DeliveryStreamCollector<T, any> {
   ...
   */
  export function toSNSTopic<T extends Shape>(
    props: SNS.TopicProps<T>,
  ): SNS.TopicCollector<T, any> {
