...
declare module "../util/stream" {
  interface Stream<E, T, D extends any[], C> {
     ...
     */
    toFirehoseDeliveryStream<T extends Shape>(
      scope: Build<core.Construct>,
      id: string,
      s3DeliveryStreamProps: DeliveryStreamDirectPut<T>,
      runtimeProps?: C,
    ): CollectedDeliveryStream<T, this>;
  }
}
Stream.prototype.toFirehoseDeliveryStream = function(
  scope: Build<core.Construct>,
  id: string,
  props: DeliveryStreamDirectPut<any>,
): any {
 ...
 */
export class DeliveryStreamCollector<
  T extends Shape,
  S extends Stream<any, Value.Of<T>, any, any>
> implements Collector<CollectedDeliveryStream<T, S>, S> {
 ...
 */
export interface CollectedDeliveryStreamProps<
  T extends Shape,
  S extends Stream<any, Value.Of<T>, any, any>
> extends DeliveryStreamDirectPut<T> {
  /**
 ...
 * @typeparam T - type of notififcations sent to, and emitted from, the DeliveryStream.
 */
export class CollectedDeliveryStream<
  T extends Shape,
  S extends Stream<any, any, any, any>
> extends DeliveryStream<T> {
  ...
  constructor(
    scope: Build<core.Construct>,
    id: string,
    props: CollectedDeliveryStreamProps<T, S>,
  ) {
