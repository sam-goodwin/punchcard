...
export abstract class BaseDeliveryStream extends core.Resource
  ...
  public grantWrite(grantable: iam.IGrantable): void {
    grantable.grantPrincipal.addToPolicy(
  ...
  public bind(
    ...
    if (!this.cloudWatchLogsRole) {
      ...
      this.cloudWatchLogsRole = new iam.Role(
        this,
      ...
      this.cloudWatchLogsRole.addToPolicy(
        new iam.PolicyStatement({
...
export class DeliveryStream extends BaseDeliveryStream {
  ...
  constructor(
    ...
    this.deliveryStreamResource = new firehose.CfnDeliveryStream(
      this,
      "DeliveryStream",
      {
        deliveryStreamType: props.type,

        elasticsearchDestinationConfiguration: this.makeElasticSearchConfig(
          props,
        ),
    ...
    this.deliveryStreamArn = this.deliveryStreamResource
      .getAtt("Arn")
      .toString();
  }
  ...
  private makeKinesisSourceConfig(
    ...
    if (props.type === DeliveryStreamType.KinesisStreamAsSource) {
      if (props.kinesisStream) {
        ...
        throw new Error(
          "must provide a Kinesis stream if type is 'KinesisStreamAsSource'",
        );
      }
    } else {
  ...
  private makeElasticSearchConfig(
    props: DeliveryStreamProps,
  ): firehose.CfnDeliveryStream.ElasticsearchDestinationConfigurationProperty {
  ...
  private makeSplunkSearchConfig(
    props: DeliveryStreamProps,
  ): firehose.CfnDeliveryStream.SplunkDestinationConfigurationProperty {
